...
description: >
  ...
  Invisibility Diagnostic. Produces 3 subject line options. Trigger on "write my newsletter",
  "newsletter this week", "email to my list", "weekly email", "write a newsletter about",
  or any topic or lesson the user wants turned into an email.
...
- YES → apply their voice. Their ICP. Their banned words. Override Daniel's defaults.
- NO → write in Daniel Paul's default voice (see `/references/voice-dna.md`)
...
Rules:
- Name the framework. A named framework is more memorable and shareable.
...
The [Number] [Noun] [Method/System/Rule/Trick]
E.g. "The 4-Line Hook Formula" / "The 3-Step Profile Fix" / "The 10-Minute Content Audit"
...
- **Voice (0 or 1):** Does this sound like a specific human?
- **POV (0 or 1):** Does it take a clear, specific position?
...
□ Framework: named, 3–5 steps, each actionable in under 10 minutes
□ Win: real number, real timeframe, what made it possible
□ Ask: one ask only, specific keyword and outcome stated
□ 3 subject line options: each uses a different formula
□ Subject lines: under 50 characters each
□ Word count: 400–600
