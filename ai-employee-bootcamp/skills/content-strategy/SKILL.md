...
description: >
  ...
  post-by-post plan. Uses web search to identify content gaps, niche saturation, and
  exact audience language before building anything. Delivers a strategy document the
  client can execute the next morning. Trigger on "content strategy", "content pillars",
  "what should I post", "build my strategy", "create a content plan", or when a client
  needs to define their LinkedIn positioning from scratch.
...
- `/references/design-system.md`, brand tokens for the strategy document header
...
**This step is non-negotiable. Never skip it. Never replace it with assumed knowledge.**
...
Week 1: [4 specific post topics, one per day Mon/Wed/Thu/Fri]
Week 2: [4 specific post topics]
Week 3: [4 specific post topics]
Week 4: [4 specific post topics], include one conversion post at end of week

**Month 2, Authority (Weeks 5–8)**
...
Week 5–8: [4 topics per week, listed specifically with hook angles]
...
Week 9–12: [4 topics per week, listed with conversion intent noted]
...
90-DAY CONTENT PLAN
[Month 1 / Month 2 / Month 3 with specific post topics]
...
□ All 4 reference files read before building
□ All 7 intake answers received before research
□ All 4 searches conducted, real findings documented
...
□ 5–6 pillars: all fields complete, all 5 validation tests passed
