...
description: >
  ...
  "cold outreach", "connection request", "follow-up", or any request to write messages for
...
Based on all signals, assign a communication style:
...
□ All 4 reference files read before writing
...
□ Zero banned words, zero em dashes, zero AI patterns in every message
