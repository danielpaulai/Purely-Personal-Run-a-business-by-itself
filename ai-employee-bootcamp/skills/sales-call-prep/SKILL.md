...
description: >
  ...
  objection scripts with word-for-word responses, transition to close, and post-call
  follow-up template. Researches the prospect from any available signals before building
  the brief. Reads the discovery call framework and output examples references.
  Trigger on "prep for a call", "discovery call", "sales call", "call tomorrow",
  "meeting with a prospect", "prep me for a call with", or after any outreach converts
  to a scheduled conversation. Part of the Purely Personal 7-skill LinkedIn lead system.
  by Daniel Paul.
---
...
Read the full objection library in `/references/discovery-call-framework.md`.
Select the 3 most likely for this specific prospect based on their situation.
...
REAL: "I've spent money on this kind of thing before and it didn't work. I'm not confident this is different."
RESPONSE: "That's fair — and it's worth addressing directly. What happened with [the previous thing]? I want to make sure I'm not describing the same thing in different packaging."
MOVE: Get the story. Then explain specifically why this is different at the process level, not just the outcome level.

**Example — Timing Objection:**
STATED: "I want to do this but the timing isn't right."
REAL: "I'm not sure this is actually going to work and I want an exit that doesn't feel like rejection."
RESPONSE: "Completely understand. Help me understand what's driving the timing — is it a resource thing, or is there something about what we've discussed that doesn't feel like the right fit?"
MOVE: The answer separates genuine timing issues from disguised objections.

**Example — Need to Think About It:**
STATED: "Can I think about it and get back to you?"
REAL: Usually either unsold on ROI or unsold on fit — not genuinely needing time.
RESPONSE: "Of course. What specifically would be most useful to think through? Sometimes talking it out helps me give you better information before you decide."
MOVE: If they can name it — address it now. If they can't name it — the objection is fear, not logic.
...
□ Prospect research conducted — exact words captured
...
□ Pain excavation: all 3 levels with specific questions
□ Objection scripts: 3 most likely for THIS prospect — not generic
...
□ Post-call follow-up: ready to send within 2 hours, uses their exact words
□ Final test: would Daniel Paul walk into this call prepared? If not — rebuild.
