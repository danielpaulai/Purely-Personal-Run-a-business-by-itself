...
- NO → write in Daniel Paul's default voice. See `/references/voice-dna.md` for every rule.
...
**Write the hook last.** Write the body first. The best hook comes from knowing what the post delivers.
...
- **Voice (0/1):** sounds like a specific human, not an AI or content agency
- **POV (0/1):** takes a clear, specific position on something
...
□ Body: one idea per paragraph, no banned words, no em dashes, specificity test passed
□ CTA: specific keyword + specific outcome
